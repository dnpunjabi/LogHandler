package com.punjabiboss.maven.helpers;

import com.google.gson.Gson;
import com.punjabiboss.maven.data.models.*;
...
public class Parser {
    public void parseLogs(BufferedReader reader, DAO dao) throws IOException, SQLException {
        HashMap<String, ServerLog> eventMap = new HashMap<String, ServerLog>();
        Gson gson = new Gson();
        String line;
        while ((line = reader.readLine()) != null) {
            ...
            HandleEvent event = new HandleEvent.Builder(eventId, duration, alert)
